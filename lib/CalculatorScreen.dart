...
class _CalculatorState extends State<Calculator> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Expanded(
            child: SingleChildScrollView( // Wrap the button rows in SingleChildScrollView
              child: Column(
                mainAxisAlignment: MainAxisAlignment.end,
                children: <Widget>[
                  buildButtonRow(["7", "8", "9", "/"], bgColor: const Color.fromARGB(255, 0, 191, 255)),
                  buildButtonRow(["4", "5", "6", "X"], bgColor: const Color.fromARGB(255, 0, 191, 255)),
                  ...
                  buildButtonRow(["CLEAR", "="], bgColor: Colors.teal, isLastRow: true),
                ],
              ),
            ),
          ),
  ...
  Widget buildButtonRow(List<String> buttonTexts, {Color textColor = Colors.white, Color bgColor = Colors.teal, bool isLastRow = false}) {
    return Row(
